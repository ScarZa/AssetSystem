        ...
        <div class="tab-content">
          ...
          <div class="tab-pane" id="control-sidebar-settings-tab">
            <form method="post">
              ...
              <div class="form-group">
                <label class="control-sidebar-subheading">
                <a href='#' onclick="AddPDCate('#index_content');">
                        <img src="images/icon_set2/gear.ico" width="25">&nbsp;&nbsp; ประเภทครุภัณฑ์ </a>
                </label>
              </div>
              <div class="form-group">
                <label class="control-sidebar-subheading">
                <a href='#' onclick="loadPage('#index_content','content/add_prods.html');">
                        <img src="images/icon_set2/gear.ico" width="25">&nbsp;&nbsp; เพิ่มครุภัณฑ์ </a>
                </label>
              </div>
              <div class="form-group">
                <label class="control-sidebar-subheading">
                <a href='#' onclick="loadPage('#index_content','content/genQRcode.html');">
                        <img src="images/icon_set2/gear.ico" width="25">&nbsp;&nbsp; สร้าง QR code </a>
                </label>
              </div> -->
              <div class="form-group">
                <label class="control-sidebar-subheading">
