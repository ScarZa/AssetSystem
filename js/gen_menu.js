            $.getJSON('JsonData/up_header.php',function (data) { 
              ...
              $("head").prepend($("<title></title>").text("ระบบทะเบียนครุภัณฑ์")
        ...
        $("body").attr("Onload",onload);
                        ...
                        $(".sidebar").append($("<ul class='sidebar-menu'></ul>"));
                                ...
                                $(".info").append($("<p>"+data.hos_name2+"</p>"),$("<a href='#'><i class='fa fa-circle text-success'></i> ระบบครุภัณฑ์</a>"));
                    ...
                    $(".control-sidebar").empty().load("menu_footer.php");                                 
                                              if((data.m_status == 'ADMIN' && data.m_process == 0) || data.m_status == 'AUSER'){
                                                  if(data.m_status == 'AUSER'){$("#gear_side1").remove();}
                                            $(".sidebar-menu").append($("<li class=''><a id='addProds' href='#'><img src='images/icon_set2/dolly.ico' width='20'> <span>เพิ่มครุภัณฑ์</span></a></li>")
                                                                    ,$("<li class=''><a id='listProds' href='#'><img src='images/icon_set2/dolly.ico' width='20'> <span>รายการครุภัณฑ์</span></a></li>")
                                                                    ,$("<li class=''><a id='company' href='#'><img src='images/icon_set2/dolly.ico' width='20'> <span>ตั้งค่าร้านค้า</span></a></li>")
                                                                    ,$("<li class=''><a id='typeProds' href='#'><img src='images/icon_set2/dolly.ico' width='20'> <span>ประเภทครุภัณฑ์</span></a></li>")
                                                                    ,$("<li class=''><a id='genQR' href='#'><img src='images/icon_set2/dolly.ico' width='20'> <span>สร้าง QR code</span></a></li>")
                                                        ...
                                                        $("#company").attr("onclick","loadPage('#index_content','content/add_store.html');");
                                                        $("#typeProds").attr("onclick","AddPDCate('#index_content');");
                                                        $("#genQR").attr("onclick"," popup('content/genQRcode.html', popup, 820, 700)");           
